...
# calculate the average
avg_rank = data.loc[:,["total_revenue (in hundred)", "total_future_customers", "total_earnings_of_BNPL", "total_future_transactions", "average fraud rate per merchant"]].mean()
avg_rank["merchant_name"] = f"average of merchants in\n {category}"

# top 5 wihtin the category
data = data.loc[[4,3,2,1,0],["merchant_name", "total_revenue (in hundred)", "total_future_customers", "total_earnings_of_BNPL", "total_future_transactions", "average fraud rate per merchant"]]
