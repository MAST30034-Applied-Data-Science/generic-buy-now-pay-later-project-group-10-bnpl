...
agg_month = joined_month.drop("merchant_name_st", "merchant_abn_st", "year_st", "month_st", 
                              "categories_st", "merchant_name_g", "merchant_abn_g", "year_g", 
                              "month_g", "categories_g")
print('4')
#============================================================================================
# Offset data by one month to create a feature containing transactions in the future month
#============================================================================================
...
x = predicting_data_pd.drop(['merchant_name', 'merchant_abn', 'categories', 'null', 'null', 
                             'future_count'], axis=1)
...
print('11')
# Save predictions
no_cust_ranking_feature = predicting_data_pd[['merchant_name','merchant_abn','prediction']]
no_cust_ranking_feature.to_csv("../data/curated/no_cust_ranking_feature.csv", index = False)
