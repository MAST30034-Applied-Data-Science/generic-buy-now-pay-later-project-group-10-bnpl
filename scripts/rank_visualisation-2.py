...
avg_rank = rank.loc[:,["total_revenue (in hundred)", "total_future_customers", "total_earnings_of_BNPL", "total_future_transactionss", "average_fraud_rate_per_merchant"]].mean()
avg_rank["merchant_name"] = "average of top 100"

# get top 5 merchants
data = rank.loc[rank_order,["merchant_name", "total_revenue (in hundred)", "total_future_customers", "total_earnings_of_BNPL", "total_future_transactionss", "average_fraud_rate_per_merchant"]]
...
# calculate the average
avg_rank0 = data0.loc[:,["total_revenue (in hundred)", "total_future_customers", "total_earnings_of_BNPL", "total_future_transactionss", "average_fraud_rate_per_merchant"]].mean()
avg_rank0["merchant_name"] = f"average of merchants in\n {category}"

# top 5 wihtin the category
data0 = data0.loc[rank_order,["merchant_name", "total_revenue (in hundred)", "total_future_customers", "total_earnings_of_BNPL", "total_future_transactionss", "average_fraud_rate_per_merchant"]]
...
# calculate the average
avg_rank1 = data1.loc[:,["total_revenue (in hundred)", "total_future_customers", "total_earnings_of_BNPL", "total_future_transactionss", "average_fraud_rate_per_merchant"]].mean()
avg_rank1["merchant_name"] = f"average of merchants in\n {category}"

data1 = data1.loc[rank_order,["merchant_name", "total_revenue (in hundred)", "total_future_customers", "total_earnings_of_BNPL", "total_future_transactionss", "average_fraud_rate_per_merchant"]]
...
# calculate the average
avg_rank2 = data2.loc[:,["total_revenue (in hundred)", "total_future_customers", "total_earnings_of_BNPL", "total_future_transactionss", "average_fraud_rate_per_merchant"]].mean()
avg_rank2["merchant_name"] = f"average of merchants in\n {category}"

data2 = data2.loc[rank_order,["merchant_name", "total_revenue (in hundred)", "total_future_customers", "total_earnings_of_BNPL", "total_future_transactionss", "average_fraud_rate_per_merchant"]]
...
# calculate the average
avg_rank3 = data3.loc[:,["total_revenue (in hundred)", "total_future_customers", "total_earnings_of_BNPL", "total_future_transactionss", "average_fraud_rate_per_merchant"]].mean()
avg_rank3["merchant_name"] = f"average of merchants in\n {category}"

data3 = data3.loc[rank_order,["merchant_name", "total_revenue (in hundred)", "total_future_customers", "total_earnings_of_BNPL", "total_future_transactionss", "average_fraud_rate_per_merchant"]]
...
# calculate the average
avg_rank4 = data4.loc[:,["total_revenue (in hundred)", "total_future_customers", "total_earnings_of_BNPL", "total_future_transactionss", "average_fraud_rate_per_merchant"]].mean()
avg_rank4["merchant_name"] = f"average of merchants in\n {category}"

data4 = data4.loc[rank_order,["merchant_name", "total_revenue (in hundred)", "total_future_customers", "total_earnings_of_BNPL", "total_future_transactionss", "average_fraud_rate_per_merchant"]]
